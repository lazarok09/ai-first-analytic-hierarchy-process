...
import { ScrollProvider } from "@/lib/scroll-store";
...
export function HomeExperience() {
  ...
  return (
    <ScrollProvider>
      ...
      <footer className="relative z-10 border-t border-white/5 px-[clamp(1.25rem,5vw,4.5rem)] py-8 font-mono text-xs tracking-wide text-steel-dim">
