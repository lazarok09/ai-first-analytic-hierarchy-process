...
- When choosing alternatives/prices for a purchase-like decision, follow `.cursor/skills/ahp-data-integrity/SKILL.md`, then `ahp constrain` + `ahp doctor --purchase`; use `ahp rate --prefer lower [--refresh]` for `alt:value`.
